...
<body>
	...
	<center>
		<div class="w3-container">
			...
			<form method="post" action="inputPro" name="userinput"
			...
			<table class="w3-table w3-bordered w3-center"
				...
				<tr>
					<td width="200">성별</td>
					<td width="400"><input type="radio" name="sex" checked="checked">
						남성 &nbsp;&nbsp; <input type="radio" name="sex"> 여성 <br></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="400">
					<textarea rows="5" cols="40"name="info"class="w3-border"></textarea>
				</tr>
