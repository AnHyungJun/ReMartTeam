	...
	<div class="paymentInfo" style="margin-left: 50px; margin-right: 50px;">
		...
		<div class="info_area">
			<table class="w3-table w3-bordered" style="font-size:14px;">
				<tr style="border-top: 1px solid #666">
					<th width="15%"
						style="border-right: none; background-color: #fff; font-weight: 100;">보내는
						분</th>
					<td width="auto" style="padding: 12px 0 10px 20px;"><input
						type="text"
						style="width: 100%; height: 28px; line-height: 28px; text-indent: 4px; border: 1px solid #bbb;"
						value="정지은"></td>
				</tr>
				<tr>
					<th width="15%"
						style="border-right: none; background-color: #fff; font-weight: 100;">휴대폰</th>
					<td width="auto" style="padding: 12px 0 10px 20px;"><input
						type="text"
						style="width: 100%; height: 28px; line-height: 28px; text-indent: 4px; border: 1px solid #bbb;"
						value="0101234567"></td>
				...
				<tr>
					<th width="15%"
						style="border-right: none; background-color: #fff; font-weight: 100;">이메일</th>
					<td width="auto" style="padding: 12px 0 10px 20px;"><input
						type="text"
						style="width: 100%; height: 28px; line-height: 28px; text-indent: 4px; border: 1px solid #bbb;"
						value="recipe@recipe.com"></td>
				</tr>
			</table>
		</div>
		<br />
		...
		<div class="info_area">
			<table class="w3-table w3-bordered" style="font-size:14px;">
				<tr style="border-top: 1px solid #666">
					<th width="15%"
						style="border-right: none; background-color: #fff; font-weight: 100;">받는
						분</th>
					<td width="auto" style="padding: 12px 0 10px 20px;"><input
						type="text"
						style="width: 100%; height: 28px; line-height: 28px; text-indent: 4px; border: 1px solid #bbb;"
		...
		<div class="info_area">
			<table class="w3-table w3-bordered" style="font-size:14px;">
				<tr style="border-top: 1px solid #666">
					<th width="15%"
						style="border-right: none; background-color: #fff; font-weight: 100;">결제
						수단</th>
					<td width="auto" style="padding: 12px 0 10px 20px;"><input
						type="checkbox" name="pay_method" value="신용카드">&nbsp;신용카드&nbsp;&nbsp;&nbsp;
						<input type="checkbox" name="pay_method" value="실시간계좌이체">&nbsp;실시간계좌이체&nbsp;&nbsp;&nbsp;
						<input type="checkbox" name="pay_method" value="가상계좌">&nbsp;가상계좌
					</td>
					<td width="20%"><input
						style="border: 1px; solid: maroon; background: transparent;"
						class="w3-border w3-border-grey w3-white w3-center" type="submit"
						value="결제하기"> <br> <br> <br></td>
				</tr>
			</table>
		</div>
