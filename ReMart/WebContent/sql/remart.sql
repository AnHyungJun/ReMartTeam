...
(
	feed_food_id varchar2(50) NOT NULL,
	feed_id varchar2(50),
	food_id varchar2(50),
...
CREATE TABLE follow
(
	follow_id varchar2(50) NOT NULL,
	my_id varchar2(50),
...
(
	food_order_id varchar2(50) NOT NULL,
	id varchar2(50),
	order_date date,
...
(
	likely_bookmark_id varchar2(50) NOT NULL,
	id varchar2(50),
	feed_id varchar2(50),
	type varchar2(10),
...
(
	mart_order_id varchar2(50) NOT NULL,
	food_id varchar2(50),
	qty number,
	-- 
	-- 
