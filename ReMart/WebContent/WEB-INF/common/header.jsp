	...
	<div class="w3-bar w3-card-2 w3-center-align w3-large" >
		<table style="width: 100%">
			<tr>
				...
				<td align="right">
					<a href="<%=request.getContextPath() %>/login/loginForm.jsp">로그인</a>|<a href="<%=request.getContextPath() %>/login/joinForm.jsp"">회원가입</a>|<a href="<%=request.getContextPath() %>/view/myPage/myPageForm.jsp">마이페이지</a>|<a href="#">장바구니</a>
				</td>
			</tr>
			<tr>
				<td>
