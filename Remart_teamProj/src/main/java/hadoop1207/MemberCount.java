...
public class MemberCount {
	public static void main(String[] args) throws Exception {
	    ...
	    // ����� ������ ��� Ȯ��  hdfs://211.238.142.247:9000/user/hadoop/dir5/
		  String inhadoop="hdfs://localhost:50071/user/HuyngJun/ch01/member.csv";
	      String outhadoop 
	      = "hdfs://localhost:50071/user/HuyngJun/ch01/Member";
	      ...
	      job.setJarByClass(MemberCount.class);    // Mapper 클래스 설정
	      job.setMapperClass(MemberCountMapper.class);    // Reducer 클래스 설정
