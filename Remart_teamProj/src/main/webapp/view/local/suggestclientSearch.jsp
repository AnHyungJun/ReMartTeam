...
<script type="text/javascript">
				...
				if (count > 0) {
					...
					for (var i = 0; i < keywordList.length; i++) {
						...
						html += "<tr><td><a href=\"javascript:select('"
								...
								+ keywordList2[2] + "')\">" + keywordList2[0]
								+ "</a></td><td>" + keywordList2[1]
	...
	function aaaaa() {
		...
		row.insertCell(3).innerHTML = "<button onclick=\"up("
				+ aa[0]
				+ ")\" class=\"w3-button w3-white w3-hover-white \" type=\"button\">▲</button>"
