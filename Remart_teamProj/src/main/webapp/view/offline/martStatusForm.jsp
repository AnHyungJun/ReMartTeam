					...
					<div class="w3-col w3-right" style="width: 40%;">
						<div class="w3-bar w3-right-align">
							<p style="font-size: 13px;">${offlineInfo.offline_mart_id }님
								&nbsp;&nbsp;&nbsp;</p>
							<input type="button"
								class="w3-bar-item w3-button w3-white w3-hover-light-grey"
								style="font-size: 12px;" name="order_status" value="발주현황"
								OnClick="order_status()"> <input type="button"
								class="w3-bar-item w3-button w3-white w3-hover-light-grey"
								style="font-size: 12px;" name="mart_month" value="매장매출"
								OnClick="go_r()"> <a
								href="<%=request.getContextPath()%>/offline/loginOut"
