	...
	function nomalfeed(imagenum,feeddate,feedid,imagename,contentname,repledata,replenum,hashtag,like,book){
   	...
   	//이미지와 제목 해쉬테그 좋아요
   		var y="<div class=\"leftdiv\" style=\"float: left; width: 45%; margin-top: 10px;\">" 
   	   		//피드 상단 프로필사진
   	   		y+="<div align=\"left\" style=\"width:100%; height:55px; margin-left:50px;\">"+
   	   		...
   	   		for(var i=0;i<imagenum;i++){   			
   	   			y+="<div align=\"center\" class=\"mySlides\" style=\"margin-left:50px; width: 100%; height: 350px;\">"+
   	    		"<img src='"+"/Remart_teamProj/fileSave/"+imagename[i]+"' width=100% height=350></div>";
   	    		//+"<label>"+contentname[i]+"</label>"+"</div>";
   	   		}
   	   		y+="<div align=\"left\" style=\"margin-top:10px; margin-left:50px; width:100%; height:40px;\">";
   			if(like==0){
   			...
   			for(var i=0;i<hashtag.length;i++){
   				if(size<30){
   					resulthashtag+="<a href=\"/Remart_teamProj/main/searchForm?please="+encodeURIComponent("#"+hashtag[i])+"\"> #"+hashtag[i]+"</a>";
   					size+=hashtag[i].length;
   				}else{
   					size=0;
   					resulthashtag+="<br><a href=\"/Remart_teamProj/main/searchForm?please="+encodeURIComponent("#"+hashtag[i])+"\"> #"+hashtag[i]+"</a>";
   					size+=hashtag[i].length;
   				}
   			}
   			...
   			for(var i=1;i<imagenum;i++){ 
   	  		...
   	  		y+="<div align=\"left\"  class=\"hash w3-text-indigo\"style=\"margin-top:10px; margin-left:50px; width: 100%; height: 50px; font-size:13px;\">"
   	  	  		+resulthashtag+"</div>";
   	  	  	y+="</div>";
   		...
   		/*리플 */
   	  	if(replenum!=0){
   			...
   			for(var i=0;i<replenum;i++){
   	   		...
   	   		var z="<div align=\"left\"  class=\"reples\"style=\"float: left; width: 31%; margin-top: 65px; margin-left:100px; font-size:12px;\"><input type=\"text\" style=\"width:200px;\" name=\""+feedid+"\"/><input class=\"w3-button w3-center w3-white w3-hover-white w3-padding-small\" style=\"font-size:12px;\" type=\"button\" value=\"reple\""
   	...
   	function editorfeed(imagenum,feeddate,feedid,imagename,contentname,repledata,replenum,foodname,hashtag,like,book){
   		...
   		var y="<div class=\"leftdiv\" style=\"float: left; width: 45%; margin-top: 10px;\">" 
   			...
   			+"<label> 재료 : "+contentname[0]+"</label><br>"+"</div>";
   			for(var i=1;i<imagenum;i++){ 
   				y+="<div align=\"left\" class=\"mySlide\" style=\"width:100%; margin-left:20px; font-size:13px;\">"
   				+"<br><label style=\"font-size:13px;\">"+contentname[i]+"</label>"+"</div>";
   			}
