...
<body>
	...
	<form action="" name="productWrite" method="POST">
		<div class="w3-container w3-border w3-center" style="width: 900px;">
			...
			<div class="w3-row">
				...
				<div class="w3-display-container w3-col w3-left-align"
					...
					<br> <br> 카테고리
					<p class="tiny"></p>
					<select name="main" onChange="showSub(this.options[this.selectedIndex].value);"> 
					...
					<select id="selMainC" class="w3-border w3-border-black" name="SUB1" style="display: ;" onchange="aaa(this.value)">
						<option value="">선택</option>
					...
					<select id="selMainC" class="w3-border w3-border-black" name="SUB2" style="display: none;" onchange="aaa(this.value)">
						<option value="">선택</option>
					...
					<select id="selMainC" class="w3-border w3-border-black" name="SUB3" style="display: none;" onchange="aaa(this.value)">
						<option value="">선택</option>
					...
					<select id="selMainC" class="w3-border w3-border-black" name="SUB4" style="display: none;" onchange="aaa(this.value)">
						<option value="">선택</option>
					...
					<select id="selMainC" class="w3-border w3-border-black" name="SUB5" style="display: none;" onchange="aaa(this.value)">
						<option value="">선택</option>
						<option value="14">쌀</option>
						<option value="15">잡곡</option>
					</select>
					
					<select id="selMainC" class="w3-border w3-border-black" name="SUB6" style="display: none;" onchange="aaa(this.value)">
						<option value="">선택</option>
						<option value="16">정육</option>
						<option value="17">계란류</option>
					</select>
					
					<select id="selMainC" class="w3-border w3-border-black" name="SUB7" style="display: none;" onchange="aaa(this.value)">
						<option value="">선택</option>
					...
					<select id="selMainC" class="w3-border w3-border-black" name="SUB8" style="display: none;" onchange="aaa(this.value)">
						<option value="">선택</option>
